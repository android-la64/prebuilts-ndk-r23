...
#define LOONGARCH_EF_CSR_ERA 32
#define LOONGARCH_EF_CSR_BADV 33
#define LOONGARCH_EF_CSR_CRMD 34
#define LOONGARCH_EF_CSR_PRMD 35
#define LOONGARCH_EF_CSR_EUEN 36
#define LOONGARCH_EF_CSR_ECFG 37
#define LOONGARCH_EF_CSR_ESTAT 38
